...
class ApiHelperTest {
    ...
    class SetBaseHostTests {
        ...
        void reemplazaVariablesEnHost() {
            DataUtilities.storeValue("host", "https://api.dynamic.com");
    ...
    class AddQueryParamTests {
        ...
        void reemplazaVariables() {
            DataUtilities.storeValue("userId", "42");
    ...
    class SetBodyTests {
        ...
        void setBodyReemplazaVariables() {
            DataUtilities.storeValue("name", "Abel");
    ...
    class ValidateResponseStatusCodeTests {
        ...
        void statusCoincideOk() throws FrameworkBusinessException {
    ...
    class ValidateResponseContainsTextTests {
        ...
        void textoEncontradoOk() throws FrameworkBusinessException {
    ...
    class AddBasicAuthTests {
        ...
        void reemplazaVariablesEnCredenciales() {
            DataUtilities.storeValue("apiUser", "admin");
            DataUtilities.storeValue("apiPass", "secret");
    ...
    class AddBearerTokenTests {
        ...
        void reemplazaVariablesEnToken() {
            DataUtilities.storeValue("jwt", "token123");
    ...
    class AddFieldTests {
        ...
        void addFieldReemplazaVariables() {
            DataUtilities.storeValue("fieldVal", "testValue");
            assertThatNoException().isThrownBy(() ->
