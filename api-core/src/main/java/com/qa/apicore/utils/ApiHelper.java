...
public class ApiHelper {
     ...
     * <p>Comportamiento por modo de ejecución:
     * <ul>
     *   <li><b>Engine mode</b>: {@link com.qa.apicore.plugin.ApiPlugin} registró {@code ApiHelper}
     *       antes de correr los escenarios → se reutiliza la instancia del registry.</li>
     *   <li><b>Standalone mode</b> (JUnit directo): {@link com.qa.apicore.steps.ApiScenarioHooks}
