 ...
 * {@link com.qa.apicore.plugin.ApiPlugin} ya registró los servicios →
 ...
 * Al estar en {@code com.qa.apicore.steps} —el mismo paquete que las step definitions—
 * se descubre automáticamente sin configuración adicional.
 *
 * @author Abel Venero
 * @since 2.0.0
 * @see com.qa.apicore.plugin.ApiPlugin
