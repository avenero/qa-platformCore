...
public class ResponseSecuritySteps {
    ...
    public void validoSinHeadersSensibles() {
        ...
        SENSITIVE_HEADERS.forEach(h ->
            Assertions.assertThat(r.getHeader(h))
                .as("Header sensible '" + h + "' no deberia estar expuesto").isNull());
    }
    ...
    public void validoSinStackTraces() {
        ...
        Assertions.assertThat(body)
            .doesNotContainIgnoringCase("at com.")
    ...
    public void validoSqlInjection(String payload) {
        ...
        Assertions.assertThat(code)
            .as("SQL Injection deberia ser rechazado").isIn(400, 401, 403, 422);
    }
    ...
    public void validoXss(String payload) {
        ...
        if (body != null) {
            Assertions.assertThat(body)
                .as("La respuesta no deberia reflejar payload XSS").doesNotContain("<script>");
        }
    }
}
