...
public class BaseAuthenticationManager implements AuthenticationService {
      ...
      if (response.getStatusCode() >= 300) {
        throw new FrameworkBusinessException(
            ...
            String.format(
                ...
                response.getStatusCode(), DataUtilities.truncateContent(response.getBody(), 500)));
      }
    ...
    try {
      ...
      String body =
          String.format(
              ...
              username,
              passwordFieldName,
              DataUtilities.sanitizeValue("password", password));
  ...
  public void setDefaultApiKey(String apiKey) {
    ...
    log.debug("API key por defecto configurada: {}", DataUtilities.sanitizeValue("apiKey", apiKey));
  }
