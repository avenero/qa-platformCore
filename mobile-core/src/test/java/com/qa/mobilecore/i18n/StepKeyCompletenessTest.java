package com.qa.mobilecore.i18n;
...
import com.qa.mobilecore.catalog.MobileStepCatalogProvider;
 ...
 * del Mundo #1 para la capa MOBILE.
 *
 * <p>Verifica las tres cláusulas del contrato sobre las claves que las
 * {@link StepCatalogEntry} del {@link MobileStepCatalogProvider} referencian
 * ({@code categoryKey}, {@code descriptionKey}, {@code params[].hintKey}) frente
 * a los bundles {@code i18n/mobile_steps_<locale>.properties} (en/es/fr):
 * <ol>
...
class StepKeyCompletenessTest {
    ...
    private final StepCatalogProvider provider = new MobileStepCatalogProvider();
