...
import com.qa.webcore.catalog.WebStepCatalogProvider;
 ...
 * del Mundo #1 para la capa WEB.
 *
 * <p>Verifica las tres cláusulas del contrato sobre las claves que las
 * {@link StepCatalogEntry} del {@link WebStepCatalogProvider} referencian
 * ({@code categoryKey}, {@code descriptionKey}, {@code params[].hintKey}) frente
 * a los bundles {@code i18n/web_steps_<locale>.properties} (en/es/fr):
 * <ol>
...
class StepKeyCompletenessTest {
    ...
    private final StepCatalogProvider provider = new WebStepCatalogProvider();
