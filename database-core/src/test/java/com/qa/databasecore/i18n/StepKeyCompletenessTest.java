package com.qa.databasecore.i18n;
...
import com.qa.databasecore.catalog.DatabaseStepCatalogProvider;
 ...
 * del Mundo #1 para la capa DATABASE.
 *
 * <p>Verifica las tres cláusulas del contrato sobre las claves que las
 * {@link StepCatalogEntry} del {@link DatabaseStepCatalogProvider} referencian
 * ({@code categoryKey}, {@code descriptionKey}, {@code params[].hintKey}) frente
 * a los bundles {@code i18n/db_steps_<locale>.properties} (en/es/fr):
 * <ol>
...
class StepKeyCompletenessTest {
    ...
    private final StepCatalogProvider provider = new DatabaseStepCatalogProvider();
