...
class DatabaseHelperTest {
    ...
    class ValidateColumnValueTests {
        ...
        void mensajeMuestraEsperadoYActual() {
            assertThatThrownBy(() ->
                ...
                .hasMessageContaining("abel@scotia.com"); // actual
        }
    ...
    class FlujoEncadenadoTests {
        ...
        void multiplesColumnasDelMismoResultado() {
            ...
            assertThat(DatabaseHelper.getColumnValue(resultado, "EMAIL")).isEqualTo("abel@scotia.com");
        }
    }
}
