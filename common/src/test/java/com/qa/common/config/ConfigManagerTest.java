...
class ConfigManagerTest {
    ...
    void setUp() {
        ...
        System.setProperty("BASE_URL", "https://test.example.com");
    ...
    // ProviderAccessTests eliminados — getUnderlyingProvider() ya no existe en ConfigManager
    // (los providers fueron eliminados en Fase 3, ConfigManager delega directo a ConfigurationUtilities)
    ...
    class FileLoadingTests {
        ...
        void testLoadConfigFile() {
            // When - Valores definidos en config-app.properties
