 ...
 *
 * <p>Esta clase unifica y migra las funcionalidades de DatabaseConfig y DbConnectionConfig
 * del paquete dbConnector hacia la nueva arquitectura de implementations. Proporciona
 * configuración robusta con múltiples fuentes (properties, environment, defaults).
 *
 * <p><b>🎯 RESPONSABILIDADES CONSOLIDADAS:</b>
 * <ul>
 *   <li><b>Configuración DataSource</b> - Creación optimizada con HikariCP</li>
 *   <li><b>Multi-source config</b> - Properties, variables entorno, defaults</li>
 *   <li><b>Configuraciones específicas</b> - Oracle, SQL Server optimizadas</li>
 *   <li><b>Pool management</b> - Configuraciones de conexión robustas</li>
 *   <li><b>Fallback strategies</b> - Configuración resiliente</li>
 * </ul>
 *
 * <p><b>🏗️ MIGRACIÓN DESDE dbConnector:</b>
 * Esta clase consolida y reemplaza:
 * <ul>
 *   <li>{@code dbConnector/config/DatabaseConfig.java}</li>
 *   <li>{@code dbConnector/config/DbConnectionConfig.java}</li>
 * </ul>
 *
 ...
 * <ul>
 *   <li><b>Oracle Database</b> - URLs, drivers, credenciales</li>
 *   <li><b>SQL Server</b> - URLs, drivers, credenciales optimizadas</li>
 *   <li><b>Pool Configuration</b> - HikariCP con settings production-ready</li>
 * </ul>
 *
...
public class BaseDatabaseConfiguration {
    ...
    private static final TestLogger.LoggerWrapper log = TestLogger.getLogger(BaseDatabaseConfiguration.class);
     ...
     */
    public static DataSource createDataSource(String databaseType, String jdbcUrl, String user, String password) {
    ...
    public static DataSource createHikariDataSource(String jdbcUrl, String user, String password, String driverClassName) {
        return createHikariDataSource(jdbcUrl, user, password, driverClassName, DEFAULT_MAX_POOL_SIZE, DEFAULT_MIN_IDLE);
    }
    ...
    public static String getOracleJdbcUrl() {
        return getConfigValue("oracle.jdbc.url", "ORACLE_JDBC_URL", "jdbc:oracle:thin:@localhost:1521:XE");
    }
    ...
    public static String getSqlServerJdbcUrl() {
        return getConfigValue("sqlserver.jdbc.url", "SQLSERVER_JDBC_URL",
    ...
    public static int getMaxPoolSize() {
        String value = getConfigValue("db.pool.max.size", "DB_POOL_MAX_SIZE", String.valueOf(DEFAULT_MAX_POOL_SIZE));
        try {
    ...
    public static int getMinIdleConnections() {
        String value = getConfigValue("db.pool.min.idle", "DB_POOL_MIN_IDLE", String.valueOf(DEFAULT_MIN_IDLE));
        try {
            return Integer.parseInt(value);
        } catch (NumberFormatException e) {
    ...
    private static void loadConfiguration() {
        ...
        try (InputStream input = BaseDatabaseConfiguration.class.getClassLoader().getResourceAsStream(CONFIG_FILE)) {
            if (input != null) {
