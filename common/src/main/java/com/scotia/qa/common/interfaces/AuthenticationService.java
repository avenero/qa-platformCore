...
/**
 * Interface para servicios de autenticación del framework Scotia QA.
 *
 * <p>Define el contrato para manejo unificado de autenticación y tokens.
 * Soporta múltiples tipos de autenticación con cache inteligente y gestión
 * automática del ciclo de vida de tokens.
 *
 * <p>Tipos de autenticación soportados:
 * <ul>
 *   <li>Client Credentials OAuth2 - Para autenticación service-to-service</li>
 *   <li>Bearer Tokens - Para autenticación con tokens específicos</li>
 *   <li>Basic Authentication - Para autenticación con usuario/contraseña</li>
 *   <li>Custom Tokens - Para tokens personalizados del negocio</li>
 * </ul>
 *
 * <p>Características principales:
 * <ul>
 *   <li>Cache automático de tokens con TTL configurable</li>
 *   <li>Renovación automática de tokens expirados</li>
...
public interface AuthenticationService {
    ...
    /**
     * Obtiene un token OAuth2 usando el flujo Client Credentials.
     * Utiliza el endpoint por defecto /oauth/token.
     *
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getClientCredentialsToken(String clientId, String clientSecret) throws FrameworkBusinessException;
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getBearerTokenForIdentifier(String endpoint, String identifier) throws FrameworkBusinessException;
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getBasicAuthToken(String authEndpoint, String username, String password) throws FrameworkBusinessException;
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getCustomToken(String tokenType, java.util.Map<String, String> parameters) throws FrameworkBusinessException;
     ...
     * Utiliza el endpoint de refresh configurado por defecto.
     *
    ...
    /**
     * Obtiene un token OAuth2 Client Credentials con scopes específicos.
     * Utiliza las credenciales y endpoint por defecto.
     *
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getClientCredentialsToken(String endpoint, String clientId, String clientSecret, String[] scopes) throws FrameworkBusinessException;
    ...
    /**
     * Verifica si un token contiene un scope específico.
     * Útil para tokens JWT que incluyen scopes en los claims.
     *
    ...
    /**
     * Obtiene un token usando autenticación multi-factor (usuario, contraseña y código MFA).
     * Utiliza el endpoint de autenticación por defecto.
     *
     * @param username el nombre de usuario
     * @param password la contraseña
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getMFAToken(String username, String password, String mfaCode) throws FrameworkBusinessException;
     ...
     * @throws FrameworkBusinessException si hay problemas obteniendo el token
     */
    String getMFAToken(String endpoint, String username, String password, String mfaCode) throws FrameworkBusinessException;
