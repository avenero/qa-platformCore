...
/**
 * Factory para crear instancias de HttpClient del framework Scotia QA.
 *
 * <p>Esta factory proporciona métodos estáticos para crear instancias de HttpClient
 * de manera estandarizada y extensible. Soporta tanto la implementación base como
 * implementaciones específicas por framework (API, Web, Mobile).
 *
 * <p><b>Características principales:</b>
 * <ul>
 *   <li>Creación estandarizada de clientes HTTP</li>
 *   <li>Soporte para extensiones específicas por framework</li>
 *   <li>Logging integrado para troubleshooting</li>
 *   <li>Patrón Factory para facilitar testing y mocking</li>
...
public final class HttpClientFactory {
    ...
    /**
     * Crea una nueva instancia de HttpClient usando la implementación base.
     * Esta es la forma más común y recomendada de obtener un HttpClient.
     *
     ...
     *
     * <p><b>Nota:</b> Actualmente retorna BaseHttpClient para todos los tipos.
     * Los frameworks específicos (api-core, web-core, mobile-core) pueden
     * extender esta funcionalidad creando sus propias implementaciones.
     *
    ...
    /**
     * Crea una instancia de HttpClient preconfigurada con un host específico.
     * Método de conveniencia para casos de uso comunes.
     *
     ...
     * Configura automáticamente los headers necesarios para trabajar con JSON.
     *
    ...
    /**
     * Crea una instancia de HttpClient preconfigurada para JSON con host específico.
     * Combina la configuración de JSON y host en un solo método.
     *
