...
/**
 * Clase de utilidad que simplifica el uso del sistema de base de datos del framework Scotia QA.
 *
 * <p>Esta clase actúa como facade de conveniencia sobre el sistema DatabaseService,
 * proporcionando métodos estáticos para operaciones comunes de testing. Mantiene
 * backward compatibility con el API existente mientras usa internamente la nueva
 * arquitectura de interfaces.
 *
 * <p><b>Arquitectura interna:</b>
 * <ul>
 *   <li>Usa {@link BaseDatabaseService} internamente</li>
 *   <li>Actúa como facade estática para fácil uso</li>
 *   <li>Mantiene backward compatibility total</li>
 *   <li>Integrado con sistema de logging TestLogger</li>
 * </ul>
 *
 ...
 * </pre>
 *
 * <p><b>Recomendación:</b> Para uso avanzado o en frameworks específicos,
 * considere usar directamente {@link DatabaseService} y {@link BaseDatabaseService}
 * para mayor control y funcionalidades adicionales.
 *
...
public class DatabaseTestUtilities {
    ...
    private static final TestLogger.LoggerWrapper log = TestLogger.getLogger(DatabaseTestUtilities.class);
    ...
    /**
     * Ejecuta una consulta simple y retorna el primer resultado como Map.
     * Mantiene backward compatibility con API existente.
     *
    ...
    public static Map<String, Object> executeQueryForMap(String dbType, String sql) {
        log.info("DatabaseTestUtils - Ejecutando consulta para Map en {}: {}", dbType, sanitizeSql(sql));
    ...
    /**
     * Ejecuta una consulta y retorna múltiples resultados como lista de Maps.
     * Mantiene backward compatibility con API existente.
     *
    ...
    public static List<Map<String, Object>> executeQueryForList(String dbType, String sql) {
        log.info("DatabaseTestUtils - Ejecutando consulta para List en {}: {}", dbType, sanitizeSql(sql));
    ...
    public static Long executeQueryForCount(String dbType, String sql) {
        log.info("DatabaseTestUtils - Ejecutando consulta de conteo en {}: {}", dbType, sanitizeSql(sql));
    ...
    public static List<Map<String, Object>> getTableColumns(String dbType, String tableName) {
        ...
        try {
            ...
            log.error("Error obteniendo columnas de tabla {} en {}: {}", tableName, dbType, e.getMessage());
            throw e;
        }
    }
     ...
     */
    public static Map<String, Object> executeQueryForMap(String dbType, String sql, Object... parameters) {
        log.info("DatabaseTestUtils - Ejecutando consulta parametrizada para Map en {}: {}", dbType, sanitizeSql(sql));
    ...
    public static int executeUpdate(String dbType, String sql, Object... parameters) {
        log.info("DatabaseTestUtils - Ejecutando update parametrizado en {}: {}", dbType, sanitizeSql(sql));
