...
/**
 * Utilidades técnicas para gestión de archivos de configuración - QA Automation Framework.
 *
 ...
 * puras sin estado, mientras que ConfigurationProvider aade servicios de alto nivel.
 *
 * @author Abel Venero
 * @version 1.0.0
 * @since 1.0.0
