...
import com.qa.httpcore.steps.validation.ResponseBodySteps;
...
public class ApiResponseBodyComponent implements StepComponent {
    ...
    public List<String> getKeywords() {
        return List.of(
            "response", "respuesta", "reponse", "body", "cuerpo",
            "json", "jsonpath", "xpath", "field", "campo",
            "extract", "extraccion", "assert", "validar", "check"
        );
    }
