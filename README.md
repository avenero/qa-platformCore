...
| Documento | Descripción |
|-----------|-------------|
| **[PIPELINE-GUIA-COMPLETA.md](docu/PIPELINE-GUIA-COMPLETA.md)** | 🚀 Jenkins Pipeline completo: Quality Gate, SonarQube, Checkmarx |
| **[GUIA_CONEXIONES_BD.md](docu/GUIA_CONEXIONES_BD.md)** | 🗄️ Conexiones multi-BD: Oracle, SQL Server, PostgreSQL, MySQL |
